...
<div class="container">
  ...
  <div class="tabs">
    <button class="tab active" data-tab="live">🔴 Live Buys</button>
...
function renderLive(buys){
  ...
  buys.forEach((b,idx)=>{
    ...
    h+='<div class="sig-meta">🐋 '+b.buyers.length+' whale(s) buying · '+b.buy_count+' buys · '+b.ago+' ago</div></div>';
    h+='<div class="sig-grade" style="background:'+b.color+'20;color:'+b.color+'">'+b.score+'<br><span style="font-size:8px">'+b.signal+'</span></div>';
    h+='<a href="https://dexscreener.com/solana/'+b.mint+'" target="_blank" style="text-decoration:none;font-size:18px;padding:4px">📊</a>';
    h+='</div></div>';
  });
